...
# 1.3 Replace 'TODO' with the relevant code
puts "After a good watering, the corn crop produced #{'TODO'} grains"
# 1.4 Replace 'TODO' with the state of the crop (ripe or not)
...
# 2.5 Replace 'TODO' with the state of the crop (ripe or not)
...
# 3.4 Replace 'TODO' with the state of the crop (ripe or not)
