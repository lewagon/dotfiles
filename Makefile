...
all: sudo xdg_specs brew stow ohmyzsh ohmyzsh_plugins asdf aws_credentials gpg_keys
...
asdf-python:
	...
	@/opt/homebrew/opt/asdf/libexec/bin/asdf install python latest
...
asdf-rust:
	...
	@/opt/homebrew/opt/asdf/libexec/bin/asdf install rust latest
...
asdf-ruby:
	...
	@/opt/homebrew/opt/asdf/libexec/bin/asdf install ruby latest
