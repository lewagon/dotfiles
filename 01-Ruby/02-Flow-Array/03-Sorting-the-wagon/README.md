...
The [`Array` class](http://www.ruby-doc.org/core-2.7.5/Array.html) is one of the two main structures used to store and access data in Ruby (the other being [Hash](http://www.ruby-doc.org/core-2.7.5/Hash.html), which we'll see tomorrow).
