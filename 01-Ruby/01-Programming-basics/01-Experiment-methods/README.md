...
Find the right ruby methods of the [String class](http://ruby-doc.org/core-2.4.0/String.html), the [Integer class](http://ruby-doc.org/core-2.4.0/Integer.html), and the [Array class](http://ruby-doc.org/core-2.2.0/Array.html) to plug in and make the tests pass.
