...
describe "The method coach_answer" do
  ...
  it 'should reply saying he does not care when you enter a statement' do
    expect( coach_answer("I would love to eat some pizza!") ).to eq "I don't care, get dressed and go to work!"
  end

  it 'should reply saying it\'s a silly question when you enter a question' do
...
describe "The method coach_answer_enhanced" do
  ...
  it 'should reply saying he does not care when you enter a statement (and does not shout)' do
    expect( coach_answer("I would love to eat some pizza!") ).to eq "I don't care, get dressed and go to work!"
  end

  it 'should reply saying it\'s a silly question when you enter a question (and does not shout)' do
    expect( coach_answer("Can I eat some pizza?") ).to eq "Silly question, get dressed and go to work!"
  end
  ...
  it 'does not answer back when you shout at him saying you are going to work' do
