...
ActiveRecord::Schema[7.1].define(version: 2024_09_04_064246) do
  ...
  create_table "group_markers", force: :cascade do |t|
    t.bigint "vtuber_id", null: false
    t.bigint "group_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_group_markers_on_group_id"
    t.index ["vtuber_id"], name: "index_group_markers_on_vtuber_id"
  end
  ...
  create_table "tag_markers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag_id"], name: "index_tag_markers_on_tag_id"
    t.index ["vtuber_id"], name: "index_tag_markers_on_vtuber_id"
  end
  ...
  add_foreign_key "group_markers", "groups"
  add_foreign_key "group_markers", "vtubers"
  add_foreign_key "list_markers", "lists"
  add_foreign_key "list_markers", "users"
  add_foreign_key "lists", "users"
  add_foreign_key "tag_markers", "tags"
  add_foreign_key "tag_markers", "vtubers"
