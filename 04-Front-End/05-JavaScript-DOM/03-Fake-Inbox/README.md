...
- (Optional) [Update the document title](https://developer.mozilla.org/en-US/docs/Web/API/Document/title) (browser tab title) so that the unread message counter appears.
