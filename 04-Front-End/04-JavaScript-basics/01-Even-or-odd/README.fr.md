...
Assure-toi que la commande suivante retourne une version supérieure à `10`:

```bash
node -v
```

Si ce n'est pas le cas, Node n'est peut-être pas installé sur ton système. Jette un œil à la section Setup dans les diapos de cours.
