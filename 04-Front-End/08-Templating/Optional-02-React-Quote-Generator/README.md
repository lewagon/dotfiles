...
In this challenge, you will build a Quote Generator app using the quotes of this [API](https://florinbobis-quotes-net.hf.space/swagger/index.html). You will learn how to:
