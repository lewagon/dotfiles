...
- Apprendre les commandes `git` de base pour versioner les modifications de ton code et les envoyer sur GitHub.
...
Travailler à deux est une pratique courante en génie logiciel. L’idée est que si tu travailles seul et te retrouves coincé, tu risques de perdre plusieurs heures à chercher le problème. Alors qu’avec un regard neuf, le problème sera identifié en quelques secondes. Ne sous-estime jamais cela !
